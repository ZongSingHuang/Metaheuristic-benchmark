...
def Shubert(X):
    # X in [-10, 10], D fixed 2
    # X* = [-7.0835, 4.8580] or [-7.0835,-7.7083] or [-7.0835,-1.4251]
    #      [-7.7083,-7.0835] or [-7.7083, 5.4828] or [-7.7083,-0.8003]
    #      [-1.4251,-7.0835] or [-1.4251,-0.8003] or [-1.4251, 5.4828]
    #      [ 4.8580,-7.0835] or [ 4.8580, 5.4828] or [ 4.8580,-0.8003]
    #      [ 5.4828, 4.8580] or [ 5.4828,-7.7083] or [ 5.4828,-1.4251]
    #      [-0.8003,-7.7083] or [-0.8003,-1.4251] or [-0.8003, 4.8580]
    # F* = -186.7309
    if X.ndim==1:
        X = X.reshape(1, -1)
